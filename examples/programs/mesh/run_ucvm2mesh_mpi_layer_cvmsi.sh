...
salloc -N 2 --ntasks=4 --time=00:30:00 srun -Q --ntasks=4 -o ${TEST}_1.srun.out ./ucvm2mesh_mpi_layer -f la_habra_cvmsi.conf -l 1 -c 3
salloc --ntasks=4 --time=00:30:00 srun -Q --ntasks=4 -o ${TEST}_2.srun.out ./ucvm2mesh_mpi_layer -f la_habra_cvmsi.conf -l 4 -c 3 
salloc --ntasks=4 --time=00:30:00 srun -Q --ntasks=4 -o ${TEST}_3.srun.out ./ucvm2mesh_mpi_layer -f la_habra_cvmsi.conf -l 7 -c 4 
