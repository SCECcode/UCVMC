...
salloc -N 2 --ntasks=4 --time=00:30:00 srun --ntasks=4 -v ./ucvm2mesh_mpi_layer -f la_habra_cvms.conf -l 1 -c 3
salloc --ntasks=4 --time=00:30:00 srun --ntasks=4 -v ./ucvm2mesh_mpi_layer -f la_habra_cvms.conf -l 4 -c 3 
salloc --ntasks=4 --time=00:30:00 srun --ntasks=4 -v ./ucvm2mesh_mpi_layer -f la_habra_cvms.conf -l 7 -c 4 
## or
