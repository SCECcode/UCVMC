...
os.system(cmd)
print cmd
cmd="./plot_scatter_plot.py -i ./norcal_map_grid_0.txt  -e 0.0 -n norcal_map_grid_0_km -o nocal_vp_versus_density_0km.png"
os.system(cmd)
print cmd
...
os.system(cmd)
print cmd
cmd="./plot_scatter_plot.py -i ./norcal_map_grid_1000.txt  -e 1000.0 -n norcal_map_grid_0_km -o nocal_vp_versus_density_1000km.png"
os.system(cmd)
print cmd
...
os.system(cmd)
print cmd
cmd="./plot_scatter_plot.py -i ./cca_map_grid_1000.txt  -e 1000.0 -n cca_map_grid_0_km -o cca_vp_versus_density_0km.png"
os.system(cmd)
print cmd
...
os.system(cmd)
print cmd
cmd="./plot_scatter_plot.py -i ./cvms5_map_grid_1000.txt  -e 1000.0 -n cvms5_map_grid_0_km -o cvms5_vp_versus_density_0km.png"
os.system(cmd)
print cmd
...
os.system(cmd)
print cmd
cmd="./plot_scatter_plot.py -i ./cvmsi_map_grid_1000.txt  -e 1000.0 -n cvmsi_map_grid_0_km -o cvmsi_vp_versus_density_0km.png"
os.system(cmd)
print cmd
