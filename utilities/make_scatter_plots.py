...
#
# 0 depth
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 0.0 -c cencal,cca,cvmsi  -o norcal_map_grid_0.txt"
os.system(cmd)
print cmd
...
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 1000.0 -c cencal,cca,cvmsi  -o norcal_map_grid_1000.txt"
os.system(cmd)
print cmd
...
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 1000.0 -c cencal  -o cencal_map_grid_1000.txt"
os.system(cmd)
print cmd
...
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 1000.0 -c cca  -o cca_map_grid_1000.txt"
os.system(cmd)
print cmd
...
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 1000.0 -c cvms5  -o cvms5_map_grid_1000.txt"
os.system(cmd)
print cmd
...
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 1000.0 -c cvmsi  -o cvmsi_map_grid_1000.txt"
os.system(cmd)
print cmd
...
cmd="./make_map_grid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 1.00 -e 1000.0 -c cvmh  -o cvmh_map_grid_1000.txt"
os.system(cmd)
print cmd
