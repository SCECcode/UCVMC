...
cmd="./makemapgrid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 0.10 -e 1000.0 -c cca  -o cca_map_grid_1000.txt"
os.system(cmd)
print(cmd)
...
cmd="./makemapgrid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 0.10 -e 1000.0 -c cvms5  -o cvms5_map_grid_1000.txt"
os.system(cmd)
print(cmd)
...
cmd="./makemapgrid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 0.10 -e 1000.0 -c cencal  -o cencal_map_grid_1000.txt"
os.system(cmd)
print(cmd)
...
cmd="./makemapgrid.py -b 30.5,-126.0 -u 42.5,-112.5 -s 0.10 -e 1000.0 -c cvmh  -o cvmh_map_grid_1000.txt"
os.system(cmd)
print(cmd)
